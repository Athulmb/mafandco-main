...
export default function MissionVision() {
  ...
  return (
    <div className="w-full bg-background py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="w-full mx-auto flex flex-col gap-12 lg:gap-20 max-w-6xl">
        ...
        >
          <motion.h2
            className="text-3xl sm:text-4xl lg:text-5xl font-lufga text-gray-900 mb-6 sm:mb-8"
            variants={textVariants}
            initial="hidden"
            animate={visibleCards.mission ? "visible" : "hidden"}
            custom={0.2}
          >
            Our Mission
          </motion.h2>
          <motion.p
            className="text-gray-700 text-base sm:text-lg lg:text-xl leading-relaxed sm:leading-8"
            variants={textVariants}
            initial="hidden"
            animate={visibleCards.mission ? "visible" : "hidden"}
            custom={0.4}
        ...
        >
          <motion.h2
            ...
            variants={textVariants}
            initial="hidden"
            animate={visibleCards.vision ? "visible" : "hidden"}
            custom={0.2}
          >
            Our Vision
          </motion.h2>
