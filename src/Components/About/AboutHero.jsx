...
const AboutHero = () => {
  ...
  // 🔹 Detect when AboutHero is in view
  useEffect(() => {
  ...
  // 🔹 Handle mouse move only when section is visible
  useEffect(() => {
    ...
    >
      ...
      <div className="w-full relative">
        <img
          ...
          className="w-full h-screen bg-cover filter brightness-75"
        />
        ...
        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 max-w-6xl px-4 sm:px-6 md:px-10 lg:px-20">
          ...
          {aboutHeroData.underline && (
            <motion.div
              ...
              animate={isVisible ? { width: "50%", opacity: 1 } : { width: 0, opacity: 0 }}
